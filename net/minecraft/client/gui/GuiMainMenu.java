...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        Client.getInstance().getDiscordRP().update("Minecraft 1.8.8", "Idle MainMenu");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String mcv = "Minecraft 1.8.8";
        String s = Cyber.name + " " + Cyber.version;
        ...
        this.drawString(this.fontRendererObj, mcv, 2, this.height - 20, -1);
        this.drawString(this.fontRendererObj, s, 2, this.height - 10, 11141290);
